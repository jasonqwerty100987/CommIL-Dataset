...
public:
  AquaSimNetDevice ();
  ~AquaSimNetDevice ();
  static Ptr<AquaSimNetDevice> CreateAquaSimNetDevice(){return CreateObject<AquaSimNetDevice>();}
  ...
  virtual void SetReceiveCallback (Callback<bool, Ptr<AquaSimNetDevice>, Ptr<const Packet>, uint16_t, const Address&> cb);
  virtual bool SupportsSendFrom (void) const;
  virtual void ForwardUp(Ptr<Packet>);
  virtual void SetSocket(Ptr<Socket>);
  virtual Ptr<Socket> GetSocket();
  virtual void SetReceiveCallback(ReceiveCallback cb);
  virtual std::map<int, std::vector<std::string>> GetResult(void);
  virtual void UpdateResult(int id, std::string data);
...
private:
  ...
  Callback<bool, Ptr<AquaSimNetDevice>, Ptr<const Packet>, uint16_t, const Address&> m_forwardUp;
